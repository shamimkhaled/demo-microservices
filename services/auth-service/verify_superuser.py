    ...
    def _assign_super_admin_role(self, user, options):
        ...
        try:
            ...
            with transaction.atomic():
                # Create or get Super Admin role for this organization
                ...
                if created:
                    ...
                    self.stdout.write(
                        self.style.SUCCESS(
                            f'✓ Assigned {all_permissions.count()} system permissions'
                        )
                    )
                else:
                ...
                if role not in user.groups.all():
                    ...
                    RoleAssignment.objects.create(
                        ...
                        assignment_reason='Automatic assignment during superuser creation'
                    )
